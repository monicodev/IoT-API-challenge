...
class AggregateQueryParams(BaseModel):
    ...
    interval: IntervalType = Field(default=IntervalType.HOUR, description="Aggregation interval")
    aggregation: AggregationType = Field(default=AggregationType.AVG, description="Aggregation function")
